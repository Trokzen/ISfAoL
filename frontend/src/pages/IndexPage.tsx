...
const IndexPage: React.FC = () => {
  ...
  const [perPage, setPerPage] = useState<number>(48); // По умолчанию 48 статей на странице
  ...
  const fetchArticles = async () => {
    try {
      ...
      if (searchId) params.append('search_external_id', searchId);
        ...
        <form onSubmit={handleSubmit}>
          <SimpleGrid cols={{ base: 1, sm: 3 }} spacing="md">
            <TextInput
              ...
              label="Поиск по внешнему ID (elibrary)"
